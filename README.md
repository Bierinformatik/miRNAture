...
## miRNAture is available on `Galaxy` Europe

A **miRNAture** v.1.1 wrapper is hosted by the Intergalactic Utilities Commission (IUA)
[repository](https://github.com/galaxyproject/tools-iuc) and can be executed from [Galaxy Europe
server](https://usegalaxy.eu/root?tool_id=toolshed.g2.bx.psu.edu/repos/iuc/mirnature/mirnature/1.1+galaxy0).
